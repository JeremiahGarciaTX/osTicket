...
This project outlines a brief overview of the steps followed to install the open-source help desk ticketing system osTicket using Microsoft Azure resource group and virtual machine services.<br />
